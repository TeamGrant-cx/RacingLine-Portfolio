    ...
    <>
      ...
      <div>
        ...
        <div className="flex flex-col items-center justify-center gap-[1rem] ">
          ...
          <p className="w-[60%] text-[2.5rem] font-[600] text-white text-center mt-[3rem] ">
        ...
        <div className="pt-[4rem] ">
          <div className="py-5 group grid grid-cols-[auto_1fr] gap-x-3 gap-y-3 relative pb-8">
            <i
            ...
            <span className=" absolute bottom-0 left-[5%] w-[35%] border-t border-[#6ECCF72B]"></span>
          </div>
          ...
          <div className="py-5 group grid grid-cols-[auto_1fr] gap-x-3 gap-y-3 relative pb-8">
            ...
            <span className=" absolute bottom-0 left-[5%] w-[40%] border-t border-[#6ECCF72B]"></span>
          </div>
