...
export default function ServiceDetailsAi({services,bgImage,topImage}) {
    ...
    <>
      <div className="px-[rem] overflow-">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 mt-[3rem] gap-[1.8rem]
          md:px-[5rem] lg:px-[2.7rem] items-stretch">
          <div className="order-2 md:order-2 lg:order-1 w-full bg--500 pt-[3rem] pr-[2.5rem] pl-[2.5rem] pb-[3rem] space-y-4 flex flex-col border-gradient-color overflow-hidden">
          ...
          <div className="order-1 md:order-1 lg:order-2 flex flex-col gap-[1.8rem]">
            <div className="relative w-full flex-none aspect-[16/10] border-gradient-color p-[0.125rem]">
              ...
              <div className="absolute z-10 left-[3%] bottom-[.7%] w-[110%] h-[160%]">
                <Image
                  className="object-cover w-full h-full bg--500"
                  src={topImage}
                  alt="Avatar Image"
                  fill
                />
            ...
            <div className="relative w-full flex-1 border-gradient-color p-[0.125rem]">
              <div className="relative w-full h-full rounded-[3rem] overflow-hidden">
                <Image
                  className="object-cover"
                  src={bgImage}
