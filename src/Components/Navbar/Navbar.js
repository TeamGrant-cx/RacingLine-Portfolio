          ...
          <div className="hidden lg:flex items-center gap-2">
            {navItems.map((item) => (
              ...
              >
                <Link
                  href={item.href}
                  className={`navbarLinks inline-flex items-center gap-[0.625rem] px-[0.938rem] py-[.5rem] rounded-[1.875rem] border-2 transition-all duration-100 backdrop-blur-sm
                    ${isActive(item.href)
